...
from src.meshlab_inertia import extract_meshlab_data
...
class TestExtractMeshLabData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_file_path = os.path.join(os.path.dirname(__file__), '../test_samples/bushing_meshlab_data.txt')
    
    def test_extract_meshlab_data(self):
        
        # Theoretical values for comparison
        expected_dimensions = [25.0, 25.0, 60.0]
        ...
        result = extract_meshlab_data(self.sample_file_path)
